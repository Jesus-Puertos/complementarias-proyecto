<main class="modalidades">
    ...
    <div class="modalidades__grid-lista">
        ...
        <div class="modalidad">
            ...
            <p class="modalidad__descripcion">
                Amplía tus horizontes académicos y profesionales con nuestra variedad de Cursos Adicionales. Desde
                tecnologías emergentes hasta habilidades blandas y temas actuales, estos cursos te permitirán
                personalizar tu educación. Prepárate para el futuro, adquiere habilidades especializadas y destaca en el
